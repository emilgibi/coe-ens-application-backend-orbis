"""add cyber risk-external supplier data

Revision ID: 7fabe13ae0e2
Revises: 383e01455de3
Create Date: 2026-06-19 15:25:03.896368
...
revision = "7fabe13ae0e2"
down_revision = "383e01455de3"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column(
        ...
        sa.Column("cyber_data", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("external_supplier_data", "cyber_data")
    op.alter_column(
        "address_zone_master",
        "geocode_source",
