...
Revision ID: fb7ef924ff5f
Revises:
Create Date: 2026-06-10 13:50:47.862456
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("user_id", "api_key", name="api_keys_unique"),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("ens_id", "group_id", name="uq_ens_group"),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column("unmodified_name", sa.String(length=255), nullable=True),
        sa.Column(
            "unmodified_name_international", sa.String(length=255), nullable=True
        ),
        sa.Column("unmodified_address", sa.Text(), nullable=True),
        sa.Column("unmodified_postcode", sa.String(length=20), nullable=True),
        sa.Column("unmodified_city", sa.String(length=100), nullable=True),
        sa.Column("unmodified_country", sa.String(length=100), nullable=True),
        sa.Column("unmodified_phone_or_fax", sa.String(length=50), nullable=True),
        sa.Column("unmodified_email_or_website", sa.String(length=100), nullable=True),
        sa.Column("unmodified_national_id", sa.String(length=50), nullable=True),
        sa.Column("unmodified_state", sa.String(length=100), nullable=True),
        sa.Column("unmodified_address_type", sa.String(length=50), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("grid_legal", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column(
            "management_info", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "create_time",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        "grid_pm_tracking",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=True),
        sa.Column("grid_tracking_id", sa.String(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(), nullable=True),
        sa.Column("associated_ens_id", sa.ARRAY(sa.String()), nullable=True),
        sa.Column(
            "create_time",
            sa.DateTime(timezone=True),
            server_default=sa.text("now()"),
    ...
    op.create_table(
        ...
        sa.Column(
            "notification_type",
            sa.Enum("UPDATE", "ALERT", "RATING_CHANGE", name="notificationtype"),
    ...
    op.create_table(
        ...
        sa.Column(
            "interval",
            sa.Enum(
                "HOUR", "DAY", "WEEK", "MONTH", "QUARTER", "YEAR", name="groupintervals"
            ),
    ...
    op.create_table(
        ...
        sa.Column(
            "mapping_type",
            sa.Enum(
                "NEW_SESSION", "RETRY_SESSION", "SKIPPED", name="periodicsessiontype"
            ),
    ...
    op.create_table(
        ...
        sa.Column("total_ens_count", sa.Integer(), nullable=True),
        sa.Column("completed_ens_count", sa.Integer(), nullable=True),
        sa.Column("failed_ens_count", sa.Integer(), nullable=True),
        sa.Column("skipped_ens_count", sa.Integer(), nullable=True),
        sa.Column(
            "source",
            sa.Enum("NU", "OD", "CM", "PD", name="sourceenum"),
            server_default=sa.text("'NU'"),
            nullable=False,
        ),
        sa.Column("source_id", sa.String(), nullable=True),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "existing_entity",
            sa.Enum("NEW", "EXISTING", name="existingtype"),
            nullable=True,
        ),
        sa.Column(
            "create_time",
