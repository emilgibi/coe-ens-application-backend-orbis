...
class ScheduleMonitoring(Base):
    ...
    interval = Column(SQLAlchemyEnum(GroupIntervals), nullable=False,server_default=expression.literal(GroupIntervals.WEEK.value))
...
class SessionGroupMapping(Base):
    ...
    mapping_type = Column(SQLAlchemyEnum(PeriodicSessionType), nullable=False,server_default=expression.literal(PeriodicSessionType.NEW_SESSION.value))
